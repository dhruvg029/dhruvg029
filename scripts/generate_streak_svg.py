...
USER = sys.argv[1] if len(sys.argv) > 1 else "dhruvg029"
OUT  = sys.argv[2] if len(sys.argv) > 2 else os.path.join(os.path.dirname(os.path.abspath(__file__)), "../svgs/streak.svg")
