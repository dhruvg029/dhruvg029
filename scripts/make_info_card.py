...
ROWS = [
    ("host",),
    ("kv", "Now", "Student in Data Science @ KU Leuven"),
    ("kv", "Prev", "Data Science Imagineer @ Fractal.ai"),
    ("kv", "Edu", "B.Tech IT, DTU (DCE) Delhi '23"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Programming", "Python, C++, R and SAS, SQL, LateX"),
    ("kv", "Technology", "ML, DSA, Deep Learning, NLP, AI, LLMs"),
    ("kv", "GenAI", "Langchain, RAGs, Vector DBs, Agents"),
    ("kv", "Cloud", "AWS, Azure, Google Cloud, Docker"),
    ("kv", "Versioning", "Git, GitHub"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "3 research publications in the field of AI and ML"),
    ("bul", "2+ years of industrial experience in Data Science"),
    ("bul", "Student Representative at LStat - KU Leuven"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">dhruvg029@github: ~$ neofetch</text>')
...
for i, row in enumerate(ROWS):
    ...
    if kind == "host":
        inner = (f'<text x="{KEY_X}" y="{y:.1f}" font-size="14" font-weight="700">'
                 f'<tspan fill="{GREEN}">dhruvg029</tspan><tspan fill="{MUTED}">@</tspan>'
